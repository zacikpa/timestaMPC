...
pub fn gg18_sign1(context: &GG18SignContext, indices: Vec<u16>, message_hash: Vec<u8>) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign2(messages: Vec<Vec<u8>>, context: &GG18SignContext1) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign3(messages: Vec<Vec<u8>>, context: &GG18SignContext2) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign4(messages: Vec<Vec<u8>>, context: &GG18SignContext3) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign5(messages: Vec<Vec<u8>>, context: &GG18SignContext4) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign6(messages: Vec<Vec<u8>>, context: &GG18SignContext5) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign7(messages: Vec<Vec<u8>>, context: &GG18SignContext6) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign8(messages: Vec<Vec<u8>>, context: &GG18SignContext7) -> (Context, ResponseWithBytes) {
...
pub fn gg18_sign9(messages: Vec<Vec<u8>>, context: &GG18SignContext8) -> (Context, ResponseWithBytes) {
